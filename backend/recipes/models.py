...
class Subscriptions(models.Model):
    """Модель, связывающая пользователя с автором, на которого он подписан."""
...
class Recipe(models.Model):
    """Модель, представляющая рецепт блюда."""
...
class UserRecipeRelation(models.Model):
    """
    Абстрактная базовая модель для отношений между пользователем и рецептом.
    """
...
class ShoppingList(UserRecipeRelation):
    """
    Модель, представляющая список покупок для пользователя.
    """
...
class FavoriteRecipes(UserRecipeRelation):
    """
    Модель, представляющая коллекцию избранных рецептов пользователя.
    """
